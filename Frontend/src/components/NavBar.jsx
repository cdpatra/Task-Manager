      ...
      <nav className="absolute p-2 flex justify-between top-0 right-0 left-0">
         ...
         <div className="flex justify-center gap-2 items-center scale-75 md:scale-100">
            {localStorage.getItem("token") ? (
               <Link to={"/user/tasks"}>
                  <button className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium  rounded-lg group bg-gradient-to-br from-green-500 to-indigo-400 group-hover:from-green-500 group-hover:to-indigo-400 hover:text-white text-white focus:ring-4 focus:outline-none  focus:ring-purple-800">
